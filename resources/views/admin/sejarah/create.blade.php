...
@section('content')
<h1 class="h3 mb-3 text-gray-800"><a href="{{ route('sambutan-kepala-sekolah.index') }}" class="text-dark"><i class="fas fa-fw fa-arrow-left mr-3"></i></a> Tambah Sambutan Kepala Sekolah</h1>

<form action="{{ route('sambutan-kepala-sekolah.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col">
            <div class="form-group">
                <label for="image">Foto Kepala Sekolah<span class="text-danger">*</span></label>
